        ...
        <tbody>
          ...
          error_reporting(0);
            ...
            if($_SERVER['REQUEST_METHOD'] == "POST") {
              ...
              if ($pencarian != '') {
                $sql = "SELECT * FROM tbl_siswa WHERE status_siswa='0' AND nama_siswa LIKE '%$pencarian%' OR id_siswa LIKE '%$pencarian' OR no_induk LIKE '%$pencarian' OR jurusan LIKE '%$pencarian' OR kelas_siswa LIKE '%$pencarian' OR agama_siswa LIKE '%$pencarian' ORDER BY id_siswa DESC";
                $query = $sql;
                $queryJml = $sql;
              } else {
                $query = "SELECT * FROM tbl_siswa WHERE status_siswa='0' ORDER BY id_siswa DESC LIMIT $posisi, $batas ";
                $queryJml = "SELECT * FROM tbl_siswa WHERE status_siswa='0' ORDER BY id_siswa DESC";
                $no = $posisi + 1;
              }
            } else {
              $query = "SELECT * FROM tbl_siswa WHERE status_siswa='0' ORDER BY id_siswa DESC LIMIT $posisi, $batas ";
