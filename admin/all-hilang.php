        ...
        <tbody>
          ...
          error_reporting(0);
            ...
            if($_SERVER['REQUEST_METHOD'] == "POST") {
              ...
              if ($pencarian != '') {
                $sql = "SELECT * FROM tbl_hilang WHERE  no_induk LIKE '%$pencarian%' ORDER BY id_hilang DESC";
                $query = $sql;
                $queryJml = $sql;
              } else {
                $query = "SELECT * FROM tbl_hilang ORDER BY id_hilang DESC LIMIT $posisi, $batas ";
                $queryJml = "SELECT * FROM tbl_hilang ORDER BY id_hilang DESC";
                $no = $posisi + 1;
              }
            } else {
              $query = "SELECT * FROM tbl_hilang  ORDER BY id_hilang DESC LIMIT $posisi, $batas ";
