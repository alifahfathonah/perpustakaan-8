<?php
    ...
    $update     = "UPDATE tbl_siswa SET no_induk='$no_induk', nama_siswa='$nama_siswa', kelas_siswa='$kelas_siswa', jurusan='$jurusan', agama_siswa='$agama_siswa', alamat_siswa='$alamat_siswa', jk_siswa='$jk_siswa', hp_siswa='$hp_siswa', email_siswa='$email_siswa'  WHERE id_siswa='$id_siswa'";
